# The Source Code of Resilient Sensor Data Dissemination Mechanism (RSDD) Implementing Disruption Resilient Transport Protocol (DRTP) for Power Transmission Grids
