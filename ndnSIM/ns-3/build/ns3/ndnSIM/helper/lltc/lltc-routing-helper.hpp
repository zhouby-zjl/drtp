...
#include "../../model/lltc/lltc-resilient-routes-generation-for-drtp.hpp"
#include "../../model/lltc/lltc-resilient-routes-generation-for-drtp-simple.hpp"
#include "../../model/lltc/lltc-resilient-routes-generation-for-reroute.hpp"
#include "../../model/lltc/lltc-resilient-routes-generation-for-static.hpp"
...
#define ROUTING_TYPE_DRTP 			0
#define ROUTING_TYPE_REROUTE 		1
#define ROUTING_TYPE_DRTP_DIJKSTRA	2
#define ROUTING_TYPE_STATIC			3
...
public:
	...
	void computeRoutesAndAddCommPairsForStaticRoutes(NodeContainer* nodes);
	void addCommPair(Ptr<Node> producerNode, Ptr<Node> consumerNode);
	void addCommPair(Ptr<Node> producerNode, Ptr<Node> consumerNode, ResilientRoutes* rr);
	list<comm_pair*>* getCommPairs();
	vector<pair<int, int>>* getCommPairIDsForStaticRoutes();
...
private:
	...
	LltcResilientRouteVectors* rrvMap_static;
