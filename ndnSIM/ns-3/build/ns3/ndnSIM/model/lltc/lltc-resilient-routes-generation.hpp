...
class ResilientRouteGenerationForDRTP;
...
public:
	...
	double maxPathDelay;
	int numDataRetransReportsToSend;

	LltcConfiguration(int numRetransRequests, int beta, double pmuFreq, double maxDriftRatioForPmuFreq,
...
public:
	...
	// This is only used for static routes generation
	unordered_map<int, ResilientRoutes*>* all_rrs;
