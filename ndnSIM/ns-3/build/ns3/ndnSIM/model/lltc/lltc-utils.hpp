...
public:
	...
	static ofstream* getLogRrReliaEvaluation();
	static ofstream* getLogProcessingCosts();
...
private:
	...
	static ofstream* logRrReliaEvaluation;
	static ofstream* logLinkTestMsgs;
	static ofstream* logProcessingCosts;
...
public:
	...
	static size_t getNDataIdsInRequestM(const Data& data);
	static size_t getNDataIdsInReport(const Data& data);
