...
private:
	...
	double computePHI(LltcLink* e, LltcNode* uNode, LltcNode* vNode, vector<RedundantSubPath*>* rsps, int nACK);


	double computeMaxRetransDelay(vector<RedundantSubPath*>* rsps, int primRetransDelayInUs, LltcConfiguration* config);
